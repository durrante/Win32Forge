...
- **Auto-documentation** — After each successful upload, Win32Forge writes a Markdown doc with all metadata, detection rules, assignments, the Intune App ID, and a direct portal link.
